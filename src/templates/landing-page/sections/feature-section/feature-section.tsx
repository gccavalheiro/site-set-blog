...
export function FeatureSection() {
  return (
    <section className="container bg-gray-700 grid gap-6 md:grid-cols-2 pt-10 pb-20 md:py-32">
      <div className="flex flex-col gap-4 rounded-lg p-6 bg-gray-500 md:p-12">
        ...
        <h2 className="text-gray-100 font-sans text-heading-lg">
      ...
      <div className="col-span-full flex flex-col gap-2">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-4 rounded-lg bg-gray-500 p-6 md:p-12">
          <div className="flex flex-col gap-4">
            ...
            <h2 className="text-gray-100 font-sans text-heading-lg lg:max-w-[340px]">
