...
export function CustomerStorySection() {
  return (
    <section className="container pt-10 pb-28 md:pt-20 md:pb-32">
      <div className="flex flex-col items-center gap-12">
        <h2
          className="text-heading-xl font-sans text-gray-100"
        >
          Quem utiliza, aprova!
        </h2>
        ...
        <div className="grid gap-8 md:grid-cols-2">
          {customerStories.map((customerStory) => (
            <div
              ...
              className="flex flex-col gap-6 border border-gray-400 rounded-lg justify-between bg-gray-500 p-6 md:p-12"
            >
