...
export const SupportSection = () => {
  return (
    <section className="relative py-10 md:py-32 bg-gray-700">
      <div className="absolute inset-0 md:block bg-[url('/background-features.svg')] bg-cover bg-center bg-no-repeat opacity-90" />

      <div className="container flex flex-col items-center gap-12 relative">
        <h2 className="font-sans text-balance text-center text-heading-xl text-gray-100 lg:max-w-lg">
