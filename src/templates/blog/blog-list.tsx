...
import { CallToActionSection } from "../landing-page/sections";
...
export function BlogList() {
  ...
  const posts = query ? allPosts.filter(post => post.title.toLowerCase().includes(query.toLocaleLowerCase())) : allPosts;
